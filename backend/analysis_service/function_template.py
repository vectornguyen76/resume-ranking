...
fn_job_analysis = [{
        ...
        "parameters": {
            ...
            "required": ["Degree", "Experience", "TechnicalSkills", "Responsibilities", "Certificates", "SoftSkills"]
        }
    }
]
...
fn_cv_analysis = [{
        ...
        "parameters": {
            ...
            "required": ["PersonalInformation", "Degree", "Experience", "TechnicalSkills", "Responsibilities", "Certificates", "SoftSkills", "Comment", "JobRecommend"],
        }
    }
]
...
fn_matching_analysis = [{
        ...
        "parameters": {
            ...
            "required": ["Degree", "Experience", "TechnicalSkills", "Responsibilities", "Certificates", "SoftSkills", "SummaryComment"],
        }
    }
]